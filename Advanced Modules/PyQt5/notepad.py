...
from PyQt5.QtWidgets import QWidget,QApplication,QTextEdit,QHBoxLayout,QLabel,QFileDialog,QPushButton,QVBoxLayout
...
class Menu(QMainWindow):
    ...
    def menuleri_olustur(self):
        ...
        temizle= QAction('Temizle dosyayı',self)
    ...
    def response(self,action):
        ...
        elif action.text() == 'Temizle dosyayı':
